...
public class App 
{
    public static void main( String[] args )
    {
        ...
        pDriver.findElement(By.id("remove-sauce-labs-bolt-t-shirt")).click();

        //CheckOut
        pDriver.findElement(By.id("checkout")).click();
        pDriver.findElement(By.id("first-name")).sendKeys("Fernanda");
        pDriver.findElement(By.id("last-name")).sendKeys("Serrano");
        pDriver.findElement(By.id("postal-code")).sendKeys("001101");
